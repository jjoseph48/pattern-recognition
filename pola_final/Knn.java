            ...
            for (int i = 0; i < this.jumData; i++) {
                if (line != null) {
                    ...
                    for (int j = 0; j < jumFitur; j++) {
                        if (j == 12) {
                            double labelTemp = Double.valueOf(isi[j]);
                            if (labelTemp == 1.000) {
                                label = "Tomat Setengah Matang";
                            } else if (labelTemp == 2.000) {
                                label = "Tomat Mentah";
                            } else {
                                label = "Tomat Matang";
                            }
                            this.labelTrain[i] = label;
//                            this.labelTrain[i] = isi[j];
    ...
    // inputkan data train tomat
    public void inputDataTest(String filePath, int jumTest) {
        
        dataTest  = new double[jumTest][jumFitur - 1];
        labelTest = new String[jumTest];
